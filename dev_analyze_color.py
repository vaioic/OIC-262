...
mask_file = Path('..\\newdata\\isp1\\qupath\\export\\isp1_s1c0x24942-4096y0-3008m0-labels.png')
image_directory = Path('..\\newdata\\isp1\\isp1.tiff_files')

output_directory = Path('..\\processed\\2026-02-10')

# Begin processing code
image_file = image_directory / (mask_file.stem[:-7] + '.tiff')
